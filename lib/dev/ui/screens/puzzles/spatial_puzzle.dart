...
import '../../../../prototype/ui/utils/my_utils.dart';
...
class SpatialPuzzleWidget extends StatelessWidget {
  ...
  SpatialPuzzleWidget({
    ...
    soundManagementRepository = SoundManagementRepositoryImpl(
        soundManager: puzzle.soundManager
    );

    spatialManagerRepository = SpatialManagementRepositoryImpl(
        model: puzzle.spatialManager
    );
              ...
              children: [
                Consumer<UniversalPuzzleToggleManager>(
                  builder: (_, universalPuzzleToggleManager, __) {
                    return ElevatedButton(
                      onPressed: () {
                        universalPuzzleToggleManager.showBag = !universalPuzzleToggleManager.canShowBag;
                      },
                      style: ElevatedButton.styleFrom(
                        elevation: 10,
                ...
                (Provider.of<UniversalPuzzleToggleManager>(     // operador ternario
                    context, listen: true
                ).canShowBag)
                    ? Column(   // consecuencia del operador ternario
                  children: [
                    Card(
                      elevation: 10,
                      child: Padding(
